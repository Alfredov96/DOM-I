...
// const navigation1 = document.querySelectorAll('a:nth-of-type(1)');
// navigation1.forEach( element => {
//   element.textContent = "Services"; 
// });

// const navigation2 = document.querySelectorAll('a:nth-of-type(1)');
// navigation2.forEach( element => {
//   element.textContent = "Product"; 
// });

// const navigation3 = document.querySelectorAll('a:nth-of-type(1)');
// navigation3.forEach( element => {
//   element.textContent = "Vision"; 
// });

// const navigation4 = document.querySelectorAll('a:nth-of-type(1)');
// navigation4.forEach( element => {
//   element.textContent = "Features"; 
// });

// const navigation5 = document.querySelectorAll('a:nth-of-type(1)');
// navigation5.forEach( element => {
//   element.textContent = "About"; 
// });

// const navigation6 = document.querySelectorAll('a:nth-of-type(1)');
// navigation6.forEach( element => {
